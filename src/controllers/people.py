...
print('Running {} on {}'.format(str(PROJECT_ID), str(GCP_ENV)))
...
class PeopleDAO:
    ...
    def __init__(self, namespace):
        """Class constructor which receives a namespace"""
    ...
    def get(self, person_id = None):
        ...
        try:
            ...
            return ResponsesHandler.error(self.namespace, 404,
                                          "Person {} doesn't exist".format(person_id), [])
    ...
    def create(self, data):
        ...
        try:
            ...
            return ResponsesHandler.error(self.namespace, 500,
                                          "Unable to save person data on Firestore")
